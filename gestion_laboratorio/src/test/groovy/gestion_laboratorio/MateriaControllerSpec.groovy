...
class MateriaControllerSpec extends Specification implements ControllerUnitTest<MateriaController>, DomainUnitTest<Materia> {
    ...
    void "Test the save action with an invalid instance"() {
        given:
        controller.materiaService = Mock(MateriaService) {
            1 * save(_ as Materia) >> { Materia materia ->
    ...
    void "Test the show action with a valid id"() {
        ...
        model.materia instanceof Materia
    }
