...
<html>
    ...
    <body>
        ...
        <div id="show-horario" class="content scaffold-show" role="main">
            ...
            <f:display bean="horario" />
            <g:form resource="${this.horario}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.horario}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
